...
int main() {
  ...
  // Addition
  num3 = num1 + num2;
  printf("Addition x+y is: %d\n", num3);
  // Suubraction
  num3 = num1 - num2;
  printf("Subtraction x-y is: %d\n", num3);
  // Multiplication
  num3 = num1 * num2;
  printf("Multiplication x*y is: %d\n", num3);
  // Integer Division
  num3 = num1 / num2;
  printf("Integer Division x / y is: %d\n", num3);
  // Modulus (remainer after Division)
  num3 = num1 % num2;
  printf("Modulus (remainer after Division) is: %d\n", num3);
  return 0;
}
